...
/* BINDTOOL_HEADER_FILE_HASH(acc8986543e538dd798bb3a5c8891269)                     */
/***********************************************************************************/
...
void bind_control_stream_to_tag_cc(py::module& m)
{
    ...
    py::class_<control_stream_to_tag_cc,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<control_stream_to_tag_cc>>(
        m, "control_stream_to_tag_cc", D(control_stream_to_tag_cc))
