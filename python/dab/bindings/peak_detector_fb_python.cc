...
/* BINDTOOL_HEADER_FILE_HASH(cff24626c2887b2ffba70a2256cdd3e8)                     */
/***********************************************************************************/
...
void bind_peak_detector_fb(py::module& m)
{
    ...
    py::class_<peak_detector_fb,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<peak_detector_fb>>(
        m, "peak_detector_fb", D(peak_detector_fb))
        ...
        .def("set_threshold_factor_rise",
             &peak_detector_fb::set_threshold_factor_rise,
             py::arg("thr"),
             D(peak_detector_fb, set_threshold_factor_rise))


        .def("set_threshold_factor_fall",
             &peak_detector_fb::set_threshold_factor_fall,
             py::arg("thr"),
             D(peak_detector_fb, set_threshold_factor_fall))


        .def("set_look_ahead",
             &peak_detector_fb::set_look_ahead,
             py::arg("look"),
             D(peak_detector_fb, set_look_ahead))


        .def("set_alpha",
             &peak_detector_fb::set_alpha,
             py::arg("alpha"),
             D(peak_detector_fb, set_alpha))


        .def("threshold_factor_rise",
             &peak_detector_fb::threshold_factor_rise,
             D(peak_detector_fb, threshold_factor_rise))


        .def("threshold_factor_fall",
             &peak_detector_fb::threshold_factor_fall,
             D(peak_detector_fb, threshold_factor_fall))


        .def("look_ahead", &peak_detector_fb::look_ahead, D(peak_detector_fb, look_ahead))


        .def("alpha", &peak_detector_fb::alpha, D(peak_detector_fb, alpha))
