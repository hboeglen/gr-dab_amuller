...
/* BINDTOOL_HEADER_FILE_HASH(5dda32bd0be7936c976db768ab02b569)                     */
/***********************************************************************************/
...
void bind_xrun_monitor_cc(py::module& m)
{
    ...
    py::class_<xrun_monitor_cc,
        ...
        .def("set_drop_when_full",
             &xrun_monitor_cc::set_drop_when_full,
             py::arg("val"),
             D(xrun_monitor_cc, set_drop_when_full))


        .def("stop_until_tag",
             &xrun_monitor_cc::stop_until_tag,
             D(xrun_monitor_cc, stop_until_tag))


        .def("set_report_fill",
             &xrun_monitor_cc::set_report_fill,
             py::arg("arg0"),
