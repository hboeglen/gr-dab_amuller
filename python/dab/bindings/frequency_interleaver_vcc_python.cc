...
/* BINDTOOL_HEADER_FILE_HASH(ec876b4f38dd5d811e7b4faec742082e)                     */
/***********************************************************************************/
...
void bind_frequency_interleaver_vcc(py::module& m)
{
    ...
    py::class_<frequency_interleaver_vcc,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<frequency_interleaver_vcc>>(
        m, "frequency_interleaver_vcc", D(frequency_interleaver_vcc))
