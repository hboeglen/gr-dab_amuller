...
/* BINDTOOL_HEADER_FILE_HASH(44ed4067e3fbca1f59904e08a831dde2)                     */
/***********************************************************************************/
...
void bind_complex_to_interleaved_float_vcf(py::module& m)
{
    ...
    py::class_<complex_to_interleaved_float_vcf,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<complex_to_interleaved_float_vcf>>(
        m, "complex_to_interleaved_float_vcf", D(complex_to_interleaved_float_vcf))
