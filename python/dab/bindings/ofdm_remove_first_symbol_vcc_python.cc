...
/* BINDTOOL_HEADER_FILE_HASH(2c36a7b66b394dac79f722fb8103bd8c)                     */
/***********************************************************************************/
...
void bind_ofdm_remove_first_symbol_vcc(py::module& m)
{
    ...
    py::class_<ofdm_remove_first_symbol_vcc,
               gr::block,
               gr::basic_block,
               std::shared_ptr<ofdm_remove_first_symbol_vcc>>(
        m, "ofdm_remove_first_symbol_vcc", D(ofdm_remove_first_symbol_vcc))
