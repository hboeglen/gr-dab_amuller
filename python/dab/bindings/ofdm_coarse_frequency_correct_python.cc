...
/* BINDTOOL_HEADER_FILE_HASH(df41b69069af952afd7e65f1736dcca1)                     */
/***********************************************************************************/
...
void bind_ofdm_coarse_frequency_correct(py::module& m)
{
    ...
    py::class_<ofdm_coarse_frequency_correct,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<ofdm_coarse_frequency_correct>>(
        m, "ofdm_coarse_frequency_correct", D(ofdm_coarse_frequency_correct))
