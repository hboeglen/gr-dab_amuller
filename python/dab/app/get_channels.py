...
def get_channels(frequency=220.352e6, rf_gain=30, if_gain=20, bb_gain=20, ppm=0, use_zeromq=False, server="tcp://127.0.0.1:10444", server_control="tcp://127.0.0.1:10445", from_file=None, from_file_repeat=False):
    ...
    dab_fic_decode_0 = dab.fic_decode(
              dab.parameters.dab_parameters(
                mode=1,
                sample_rate=samp_rate,
                verbose=False
